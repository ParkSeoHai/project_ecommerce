            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-5 group-icon-header ps-3">
                    <ul class="list-icon-header d-flex align-items-center justify-content-between">
                        ...
                        <li class="item item-dropdown" @click="showDropdownStore('ddownStoreAddress')">
                        ...
                        <li class="item item-dropdown" @click="showDropdownStore('ddownLogin')">
                        ...
                        <li class="item item-dropdown" @click="showDropdownStore('ddownCart')">
                            <div class="cart">
...
function showDropdownStore(dropDownName) {
